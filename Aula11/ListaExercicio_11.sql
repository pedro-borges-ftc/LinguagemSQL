...
/*Escreva uma View que retorne o nome do cliente, a quantidade de finanças e o saldo final no mes de fevereiro, para todas as entradas em que o cliente seja você.*/
CREATE VIEW vwExercicio02 AS
select 
	/*c.nome as NomeCliente,*/
...
/*Escreva uma View que retorne o nome do cliente a descrição da finança, a quantidade de finanças e o somatório agrupado pela descrição da finança, para todas as entradas em que o cliente seja você. */
CREATE VIEW vwExercicio03 AS
select 
	/*c.nome as NomeCliente,*/
    'FULANO DE TALZ' AS NomeCliente,
    descricao as DescriçãoFinança,
...
/*Escreva uma View que retorne a descrição da finança, o vencimento da finança,  o valor e o saldo do dia para todas as entradas em que o cliente seja você.*/
CREATE VIEW vwExercicio04 AS
select 
    descricao as DescriçãoFinança,
    vencimento as DiaVencimento, 
    valor * tipolancamento as ValorR$, 
